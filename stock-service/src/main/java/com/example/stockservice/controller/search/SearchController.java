...
public class SearchController {
    ...
    @Operation(
        ...
        description = "Smart search with query parsing, caching, and filtering. Supports Vietnamese and English."
    )
    ...
    @Operation(
        ...
        description = "Returns product names, categories, and search history matching the query"
    )
    ...
    @Operation(
        ...
        description = "Returns recent search queries for the authenticated user"
    )
    ...
    @Operation(
        ...
        description = "Deletes all search history for the authenticated user"
    )
    ...
    @Operation(
        summary = "Remove search history item",
        description = "Removes a specific query from user's search history"
    )
