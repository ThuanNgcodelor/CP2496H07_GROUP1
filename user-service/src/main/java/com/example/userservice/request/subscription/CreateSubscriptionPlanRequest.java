...
public class CreateSubscriptionPlanRequest {
    ...
    // Commission rates
    @NotNull(message = "Commission payment rate is required")
    ...
    private BigDecimal commissionPaymentRate = new BigDecimal("0.0400");

    @NotNull(message = "Commission fixed rate is required")
    ...
    private BigDecimal commissionFixedRate = new BigDecimal("0.0400");

    @NotNull(message = "Commission freeship rate is required")
    ...
    private BigDecimal commissionFreeshipRate = new BigDecimal("0.0800");

    @NotNull(message = "Commission voucher rate is required")
    ...
    private BigDecimal commissionVoucherRate = new BigDecimal("0.0500");

    @DecimalMin(value = "0.0", message = "Voucher max per item must be >= 0")
    private BigDecimal voucherMaxPerItem = new BigDecimal("50000");
